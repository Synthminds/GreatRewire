...
SLATE = [
 dict(id="A1", g="A", p=62,
   ...
   note="Live rate depends on method and vintage: 12.1% statutory average (Yale Budget Lab, Jul 21 2026) vs ~8.1% trade-weighted after the Feb 2026 ruling. The resolver pins one method — USITC duties ÷ customs value — precisely because these diverge."),
 dict(id="A2", g="A", p=38,
   ...
   reads="a resumption bet — the freeze breaks with the truce",
 ...
 dict(id="C6", g="C", p=45,
   ...
   note="Gauge compares 2026 guided spending against a calendar-2027 threshold — one year of growth has to happen inside the gap."),
 dict(id="C7", g="C", p=75,
